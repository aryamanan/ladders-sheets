...
## Advanced CSES / Competitive Programming Add-On

This section is beyond the average FAANG interview, but it closes the gaps if an interviewer is unusually algorithm-heavy.

### Advanced Graphs

1. [Planets and Kingdoms](https://cses.fi/problemset/task/1683) - SCC condensation.
2. [Giant Pizza](https://cses.fi/problemset/task/1684) - 2-SAT.
3. [Coin Collector](https://cses.fi/problemset/task/1686) - SCC plus DAG DP.
4. [Hamiltonian Flights](https://cses.fi/problemset/task/1690) - bitmask DP on graph.
5. [Mail Delivery](https://cses.fi/problemset/task/1691) - Eulerian circuit.
6. [De Bruijn Sequence](https://cses.fi/problemset/task/1692) - Eulerian path construction.
7. [Teleporters Path](https://cses.fi/problemset/task/1693) - directed Eulerian path.
8. [Download Speed](https://cses.fi/problemset/task/1694) - max flow.
9. [Police Chase](https://cses.fi/problemset/task/1695) - min cut.
10. [School Dance](https://cses.fi/problemset/task/1696) - bipartite matching.
11. [Distinct Routes](https://cses.fi/problemset/task/1711) - max flow path decomposition.

### Advanced Trees

1. [Tree Matching](https://cses.fi/problemset/task/1130) - tree DP.
2. [Tree Distances I](https://cses.fi/problemset/task/1132) - rerooting idea.
3. [Tree Distances II](https://cses.fi/problemset/task/1133) - rerooting DP.
4. [Distance Queries](https://cses.fi/problemset/task/1135) - LCA.
5. [Counting Paths](https://cses.fi/problemset/task/1136) - path contribution plus LCA.
6. [Subtree Queries](https://cses.fi/problemset/task/1137) - Euler tour plus Fenwick/segment tree.
7. [Path Queries](https://cses.fi/problemset/task/1138) - tree path sums.
8. [Path Queries II](https://cses.fi/problemset/task/2134) - heavy-light decomposition.
9. [Finding a Centroid](https://cses.fi/problemset/task/2079) - centroid basics.
10. [Fixed-Length Paths I](https://cses.fi/problemset/task/2080) - centroid or tree counting.
11. [Fixed-Length Paths II](https://cses.fi/problemset/task/2081) - harder centroid/tree counting.

### Advanced Range Queries

1. [Distinct Values Queries](https://cses.fi/problemset/task/1734) - offline queries.
2. [Range Updates and Sums](https://cses.fi/problemset/task/1735) - lazy segment tree.
3. [Polynomial Queries](https://cses.fi/problemset/task/1736) - lazy propagation with arithmetic updates.
4. [Range Queries and Copies](https://cses.fi/problemset/task/1737) - persistent segment tree.
5. [Pizzeria Queries](https://cses.fi/problemset/task/2206) - transformed segment tree queries.
6. [Subarray Sum Queries](https://cses.fi/problemset/task/1190) - segment tree with prefix/suffix/best.
7. [Prefix Sum Queries](https://cses.fi/problemset/task/2166) - segment tree with max prefix.
8. [List Removals](https://cses.fi/problemset/task/1749) - order statistics with Fenwick.

### Advanced Strings

1. [Word Combinations](https://cses.fi/problemset/task/1731) - trie/DP.
2. [String Matching](https://cses.fi/problemset/task/1753) - KMP/Z/rolling hash.
3. [Finding Borders](https://cses.fi/problemset/task/1732) - prefix function.
4. [Finding Periods](https://cses.fi/problemset/task/1733) - string periods.
5. [Minimal Rotation](https://cses.fi/problemset/task/1110) - Booth or suffix techniques.
6. [Longest Palindrome](https://cses.fi/problemset/task/1111) - Manacher.
7. [Pattern Positions](https://cses.fi/problemset/task/2104) - suffix array/tree/automaton style.
8. [Distinct Substrings](https://cses.fi/problemset/task/2105) - suffix array or suffix automaton.
9. [Repeating Substring](https://cses.fi/problemset/task/2106) - suffix array/LCP.
10. [String Functions](https://cses.fi/problemset/task/2107) - Z-function and prefix function.
11. [Substring Order I](https://cses.fi/problemset/task/2108) - suffix array.
12. [Substring Order II](https://cses.fi/problemset/task/2109) - suffix array with repeated substrings.
13. [Substring Distribution](https://cses.fi/problemset/task/2110) - suffix array/LCP counting.

### Advanced DP and Meet-in-the-Middle

1. [Elevator Rides](https://cses.fi/problemset/task/1653) - bitmask DP.
2. [Counting Tilings](https://cses.fi/problemset/task/2181) - profile DP.
3. [Counting Numbers](https://cses.fi/problemset/task/2220) - digit DP.
4. [Projects](https://cses.fi/problemset/task/1140) - weighted interval DP.
5. [Increasing Subsequence](https://cses.fi/problemset/task/1145) - LIS.
6. [Rectangle Cutting](https://cses.fi/problemset/task/1744) - interval/grid DP.
7. [Money Sums](https://cses.fi/problemset/task/1745) - bitset/knapsack.
8. [Meet in the Middle](https://cses.fi/problemset/task/1628) - subset splitting.
