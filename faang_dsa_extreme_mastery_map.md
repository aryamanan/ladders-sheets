...
In-Place Index Encoding And Cyclic Placement Overview:
...
In-Place Index Encoding And Cyclic Placement Foundation:
...
Hashmap Complement / Pair-Sum Counting Reinforcement:
...
Frequency-Driven Reordering Reinforcement:
...
Multiset / Bijection Equality Checks Reinforcement:
...
Prefix-Sum Hashmap Counting Overview:
...
Prefix-Sum Hashmap Counting Foundation:
...
Prefix-Sum Hashmap Counting Reinforcement:
...
Prefix-Sum Hashmap Counting Boss:
...
Difference Arrays For Range Updates Reinforcement:

1. [Zero Array Transformation II](https://leetcode.com/problems/zero-array-transformation-ii/)


Difference Arrays For Range Updates Boss:
...
Prefix Aggregates Beyond Plain Sums Reinforcement:
...
Prefix Aggregates Beyond Plain Sums Boss:
...
Sorted-Array Opposite-End Pointers Overview:
...
Fast/Slow And Cross-Structure Two Pointers Foundation:
...
Fast/Slow And Cross-Structure Two Pointers Reinforcement:
...
Fast/Slow And Cross-Structure Two Pointers Boss:
...
Fixed-Size Window Aggregation Reinforcement:
...
Fixed-Size Window Aggregation Boss:
...
Variable Window With A Budget Or Constraint Reinforcement:
...
Variable Window With A Budget Or Constraint Boss:
...
Monotonic Deque Window Extremum Overview:
...
Monotonic Deque Window Extremum Foundation:

1. [Continuous Subarrays](https://leetcode.com/problems/continuous-subarrays/)


Monotonic Deque Window Extremum Boss:
...
Custom Comparator Sort Overview:
...
Custom Comparator Sort Foundation:
...
Custom Comparator Sort Reinforcement:
...
Interval Merge, Containment, And Sweep Reinforcement:
...
Interval Merge, Containment, And Sweep Boss:
...
Binary Search On Index Reinforcement:
...
Binary Search On A Property, Not An Exact Value Boss:

1. [Find a Peak Element II](https://leetcode.com/problems/find-a-peak-element-ii/)


Binary Search On The Answer Overview:
...
Binary Search On The Answer Foundation:
...
Binary Search On The Answer Reinforcement:
...
Binary Search On The Answer Boss:
...
Bracket / Bracket-Like Validity Stacks Reinforcement:
...
Monotonic Stack: Next Greater/Smaller Overview:
...
Monotonic Stack: Next Greater/Smaller Foundation:

1. [Next Greater Element I](https://leetcode.com/problems/next-greater-element-i/)


Monotonic Stack: Next Greater/Smaller Reinforcement:
...
Monotonic Stack: Next Greater/Smaller Boss:
...
Monotonic Stack: Counting Contribution Overview:
...
Monotonic Stack: Counting Contribution Foundation:

1. [Number of Valid Subarrays](https://leetcode.com/problems/number-of-valid-subarrays/)


Simulation Via Explicit Stack Overview:
...
Simulation Via Explicit Stack Foundation:
...
Simulation Via Explicit Stack Reinforcement:
...
Simulation Via Explicit Stack Boss:
...
Stack-Backed Data Structure Design Reinforcement:
...
Stack-Backed Data Structure Design Boss:
...
Greedy Rearrangement / Construction Via Heap Foundation:
...
Greedy Rearrangement / Construction Via Heap Reinforcement:
...
Greedy Rearrangement / Construction Via Heap Boss:
...
Heap-Scheduled Greedy Over Time Overview:
...
Streaming Design With Lazy Deletion Overview:
...
Streaming Design With Lazy Deletion Foundation:

1. [Seat Reservation Manager](https://leetcode.com/problems/seat-reservation-manager/)


Streaming Design With Lazy Deletion Reinforcement:
...
Dummy Node And In-Place Reversal Overview:
...
Dummy Node And In-Place Reversal Foundation:
...
Dummy Node And In-Place Reversal Reinforcement:
...
Dummy Node And In-Place Reversal Boss:
...
Splicing And Restructuring Reinforcement:
...
Splicing And Restructuring Boss:
...
Value Accumulation While Traversing Overview:
...
Value Accumulation While Traversing Foundation:
...
Value Accumulation While Traversing Reinforcement:

1. [Add Two Numbers II](https://leetcode.com/problems/add-two-numbers-ii/)


Value Accumulation While Traversing Boss:
...
Deep Copy And Cross-Structure Reasoning Foundation:
...
Deep Copy And Cross-Structure Reasoning Boss:
...
Streaming Counters With Time Windows Overview:
...
Hashing And Encoding From Scratch Foundation:

1. [Design HashMap](https://leetcode.com/problems/design-hashmap/)


Hashing And Encoding From Scratch Boss:
...
Level-Order (BFS) Traversal Variants Overview:
...
Level-Order (BFS) Traversal Variants Foundation:
...
Level-Order (BFS) Traversal Variants Reinforcement:
...
Level-Order (BFS) Traversal Variants Boss:
...
Structural Equality And Comparison Overview:
...
Structural Equality And Comparison Foundation:

1. [Same Tree](https://leetcode.com/problems/same-tree/)
2. [Symmetric Tree](https://leetcode.com/problems/symmetric-tree/)


Structural Equality And Comparison Reinforcement:
...
Structural Equality And Comparison Boss:
...
Root-to-Leaf Path Accumulation Overview:
...
Root-to-Leaf Path Accumulation Foundation:
...
Root-to-Leaf Path Accumulation Reinforcement:
...
Root-to-Leaf Path Accumulation Boss:
...
BST Property Exploitation (Inorder Is Sorted) Overview:
...
BST Property Exploitation (Inorder Is Sorted) Foundation:
...
BST Property Exploitation (Inorder Is Sorted) Reinforcement:
...
BST Property Exploitation (Inorder Is Sorted) Boss:
...
Construction From Traversals / Serialization Overview:
...
Construction From Traversals / Serialization Foundation:
...
Construction From Traversals / Serialization Reinforcement:
...
Construction From Traversals / Serialization Boss:
...
Post-Order Aggregation (Bottom-Up) Overview:
...
Post-Order Aggregation (Bottom-Up) Boss:
...
Counting BST Shapes (Catalan-Style Recursion) Overview:
...
Trie Construction Fundamentals Overview:
...
Trie-Pruned Board/Grid Search Foundation:
...
Approximate / Multi-Constraint Trie Matching Overview:
...
Approximate / Multi-Constraint Trie Matching Foundation:

1. [Camelcase Matching](https://leetcode.com/problems/camelcase-matching/)


Approximate / Multi-Constraint Trie Matching Reinforcement:

1. [Implement Magic Dictionary](https://leetcode.com/problems/implement-magic-dictionary/)


Approximate / Multi-Constraint Trie Matching Boss:
...
Autocomplete / Prefix-Count Applications Foundation:
...
Autocomplete / Prefix-Count Applications Boss:
...
Hashing / Window Substring Checks Boss:
...
Exact Pattern Matching (KMP / Prefix Function) Overview:
...
Exact Pattern Matching (KMP / Prefix Function) Foundation:

1. [String Matching](https://cses.fi/problemset/task/1753)


Exact Pattern Matching (KMP / Prefix Function) Boss:
...
Subsequence Matching At Scale Overview:
...
Grid Flood Fill / Connected Components Boss:
...
3. [Number of Distinct Islands](https://www.geeksforgeeks.org/problems/number-of-distinct-islands/1)
3. [Shortest Bridge](https://leetcode.com/problems/shortest-bridge/)


Multi-Source BFS Overview:
...
Implicit Graph Construction Overview:
...
Implicit Graph Construction Boss:
...
Connectivity Under Constraints Overview:
...
Topological Sort Fundamentals Boss:
...
Topological-Order DP Foundation:
...
Topological-Order DP Reinforcement:
...
Dependency Resolution (Kahn's Algorithm Applications) Foundation:
...
Dependency Resolution (Kahn's Algorithm Applications) Boss:
...
Strongly Connected Components Foundation:
...
Incremental / Online DSU Boss:

1. [Road Construction](https://cses.fi/problemset/task/1676)


Offline Reverse-Order DSU Overview:
...
Minimum Spanning Tree Foundation:
...
Minimum Spanning Tree Reinforcement:

1. [Road Reparation](https://cses.fi/problemset/task/1675)


Minimum Spanning Tree Boss:
...
Single-Source Dijkstra Fundamentals Overview:
...
State-Space Shortest Path (Augmented State) Foundation:
...
State-Space Shortest Path (Augmented State) Reinforcement:
...
State-Space Shortest Path (Augmented State) Boss:
...
Multi-Source / Plain BFS Shortest Path Reinforcement:
...
Incremental Shortest-Path Recomputation Foundation:
...
Incremental Shortest-Path Recomputation Boss:
...
Flow-Structure Recognition Foundation:
...
Exchange-Argument Sort-Then-Greedy Overview:
...
Exchange-Argument Sort-Then-Greedy Foundation:
...
Frequency-Driven Greedy Construction Boss:
...
Deadline/Scheduling Greedy Foundation:
...
Backtracking With Seen-Set Pruning Overview:
...
Bitmask-Pruned Subset Backtracking Overview:
...
Bitmask-Pruned Subset Backtracking Foundation:
...
Linear Recurrence Warm-Up Overview:
...
Climbing-Stairs-Shaped Counting/Decision DP Boss:
...
Take-Or-Skip Running DP Foundation:
...
Small Fixed-State Combinatorial DP Foundation:
...
Small Fixed-State Combinatorial DP Boss:
...
Sequential Cost DP With Adjacency Constraint Foundation:

1. [Paint House](https://leetcode.com/problems/paint-house/)


Sequential Cost DP With Adjacency Constraint Boss:
...
LIS Fundamentals And Reductions Reinforcement:
...
LIS Fundamentals And Reductions Boss:
...
LIS-Family Two-State DP Overview:
...
Subset-Partition Knapsack Overview:
...
Subset-Partition Knapsack Foundation:

1. [Tallest Billboard](https://leetcode.com/problems/tallest-billboard/)


Subset-Partition Knapsack Boss:
...
Grouped/Bounded-Choice Knapsack Overview:
...
LCS Family (Two-String Alignment DP) Overview:
...
LCS Family (Two-String Alignment DP) Foundation:
...
LCS Family (Two-String Alignment DP) Reinforcement:
...
LCS Family (Two-String Alignment DP) Boss:
...
Near-Match / Counting-Differences DP Overview:

- Invariant: Track the number of mismatches allowed so far as an explicit DP dimension.


Near-Match / Counting-Differences DP Foundation:
...
Pattern-Consistency Counting DP Foundation:

1. [Count Number of Texts](https://leetcode.com/problems/count-number-of-texts/)


Pattern-Consistency Counting DP Boss:
...
Rank/Permutation Counting DP Foundation:
...
Grid DP: Row-to-Row Transitions Reinforcement:
...
Grid DP: Row-to-Row Transitions Boss:
...
Grid DP: Path Existence/Counting Under Direction Constraints Overview:
...
Grid DP: Path Existence/Counting Under Direction Constraints Foundation:

1. [Check if There is a Valid Path in a Grid](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid/)


Grid DP: Path Existence/Counting Under Direction Constraints Boss:
...
Grid DP: Resource Collection Overview:
...
State-Machine / Multi-Dimension Decision DP Overview:
...
State-Machine / Multi-Dimension Decision DP Foundation:
...
State-Machine / Multi-Dimension Decision DP Boss:
...
Bitmask DP Over Subsets Overview:
...
Fenwick Tree / BIT Fundamentals Overview:
...
Fenwick Tree / BIT Fundamentals Foundation:
...
Fenwick Tree / BIT Fundamentals Boss:
...
Order-Statistics / Coordinate-Compressed BIT Boss:
...
2D Fenwick Tree Foundation:

1. [Forest Queries II](https://cses.fi/problemset/task/1739)


Offline Query Structures For Distinctness Overview:
...
Offline Query Structures For Distinctness Foundation:
...
Number Theory: Primes, Divisors, Factorization Boss:
...
XOR Identities And Prefix-XOR Tricks Foundation:
...
XOR Identities And Prefix-XOR Tricks Reinforcement:
...
XOR Identities And Prefix-XOR Tricks Boss:
...
Bit-Pattern Validation / Parsing Overview:
...
Computational Geometry: Orientation And Intersection Foundation:

1. [Point Location Test](https://cses.fi/problemset/task/2189)


Computational Geometry: Orientation And Intersection Reinforcement:

1. [Line Segment Intersection](https://cses.fi/problemset/task/2190)


Computational Geometry: Orientation And Intersection Boss:

1. [Point in Polygon](https://cses.fi/problemset/task/2192)


Computational Geometry: Area, Distance, Convex Hull Overview:
...
Computational Geometry: Area, Distance, Convex Hull Foundation:

1. [Polygon Area](https://cses.fi/problemset/task/2191)


Computational Geometry: Area, Distance, Convex Hull Reinforcement:
...
Computational Geometry: Area, Distance, Convex Hull Boss:
